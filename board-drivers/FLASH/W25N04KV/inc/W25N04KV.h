...
#ifndef W25N04KV_H	// Begin header include protection
#define W25N04KV_H
...
#define W25N04KV_NUM_PAGES (uint32_t) 262080

// Each page has a 2048-byte main data array to read/write
#define W25N04KV_BYTES_PER_PAGE (uint16_t) 2048
...
#define W25N04KV_SECTOR_SIZE (uint16_t) 512
...
typedef struct {
	...
	uint8_t write_buffer[W25N04KV_SECTOR_SIZE];
	...
	uint32_t current_page;        // Tracking pages while writing
	...
	W25N04KV_ECC_Status last_read_ECC_status;
